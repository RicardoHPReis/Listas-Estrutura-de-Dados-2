...
int calculaAlturaArvore(Arvore *arv)
{
	...
	if(!verificaVazio(arv))
    {
        if(!verificaVazio(arv->esq))
			...
			altura++;
		altura += calculaAlturaArvore(arv->esq);
		altura += calculaAlturaArvore(arv->dir);
    }
    return altura;
}
...
int main()
{
	...
	a1 = constroiArvore('a', NULL, a0);
    a2 = constroiArvore('b', NULL, a1);
    a3 = constroiArvore('c', NULL, NULL);
    a4 = constroiArvore('d', NULL, NULL);
    a5 = constroiArvore('e', a3, a4);
    arv = constroiArvore('f', a2, a5);
